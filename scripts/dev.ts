...
const embeddedPostgres = new EmbeddedPostgres({ databaseDir: "./dev-db", user, password, port });
...
const env = { ...process.env, DATABASE_URL: LOCAL_DATABASE_URL };
spawn("vite", { stdio: "inherit", shell: true, env });
spawn("npx drizzle-kit studio", { stdio: "inherit", shell: true, env });
